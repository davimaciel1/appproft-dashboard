...
router.get('/metrics', async (req, res) => {
  try {
    ...
    secureLogger.error('Erro ao buscar métricas', { error: error.message });
...
async function getAmazonMetrics() {
  ...
  try {
    ...
    secureLogger.error('Erro ao buscar dados Amazon', { error: error.message });
    throw error;
  }
}
...
async function getMercadoLivreMetrics() {
  ...
  try {
    ...
    secureLogger.error('Erro ao buscar dados Mercado Livre', { error: error.message });
    throw error;
  }
}
